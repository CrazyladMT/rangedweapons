	...
	core.register_tool("rangedweapons:mp40_r", {
	...
	core.register_tool("rangedweapons:mp40_rr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	...
	core.register_tool("rangedweapons:mp40_rrr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	inventory_image = "rangedweapons_mp40.png",
	...
	core.register_tool("rangedweapons:mp40", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.5},
