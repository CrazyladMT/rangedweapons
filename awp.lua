core.register_tool("rangedweapons:awp_uld", {
	stack_max= 1,
	wield_scale = {x = 1.9, y = 1.9, z = 1.1},
	range = 0,
	description = core.colorize("#35cdff","A.W.P. \n") ..
		"Ranged damage:18 + 35/sec of bullet lifetime\n" ..
		"Accuracy: 100%\n" ..
		"knockback: 15\n" ..
		"Critical chance: 30%\n" ..
		"Critical efficiency: x3\n" ..
		"Ammunition: 7.62mm round/308.Winchester rounds\n" ..
		"Rate of fire: 1.0\n" ..
		"Reload time: 2.0\n" ..
		"Zoom: 12x\n" ..
		core.colorize("#be0d00", "Right-click to eject empty bullet shell\n") ..
		"Clip size: 10/10\n" ..
		"Enemy penetration:30%\n" ..
...
core.register_tool("rangedweapons:awp_r", {
...
core.register_tool("rangedweapons:awp_rr", {
...
core.register_tool("rangedweapons:awp_rrr", {
...
core.register_tool("rangedweapons:awp_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
