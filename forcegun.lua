...
core.register_tool("rangedweapons:forcegun", {
	description = core.colorize("#35cdff","Force gun\n") ..
		"Completelly harmless... by itself...\n" ..
		"It's projectile will push either the entity it hits directly, or everyone near the node it collides with far away.\n" ..
		"Perfect for rocket-jumping or YEETing enemies away.\n" ..
		"Power usage: 40\n" ..
		"Gun type: Power Special-gun\n" ..
		"Bullet velocity: 60",
