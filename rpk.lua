...
core.register_tool("rangedweapons:rpk_r", {
	stack_max= 1,
...
core.register_tool("rangedweapons:rpk_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
...
core.register_tool("rangedweapons:rpk_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	...
	core.register_tool("rangedweapons:rpk", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
